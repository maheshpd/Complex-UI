...
//  Complex UI
//
//  Created by Mahesh Prasad on 05/08/20.
        ...
        VStack {
            ZStack(alignment: .top) {
                        ...
                        Button(action: {
                            ...
                            VStack(spacing: 8) {
                                ZStack{
                                    ...
                                    Circle()
                                        .stroke(self.color == 1 ? Color.yellow : Color.orange, lineWidth: 2)
                                        .frame(width: 30, height: 30)
                                }
                ...
                HStack{
                    ...
                    .clipShape(CustomeShape(corner: .bottomLeft, radii: self.height > 800 ? 35 : 30))
                    
                }
                
            }
            .background(self.color == 0 ? Color.yellow : Color.orange)
            .clipShape(CustomeShape(corner: .bottomLeft, radii: 55))
            ...
            HStack{
                ...
                .background(self.color == 0 ? Color.yellow : Color.orange)
                .clipShape(CustomeShape(corner: .topLeft, radii: 55))
            }
        }
